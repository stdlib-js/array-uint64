...
tape( 'the constructor returns a 64-bit unsigned integer array (no argument)', function test( t ) {
	var arr = new Uint64Array();
	t.strictEqual( arr instanceof Uint64Array, true, 'returns expected value' );
	t.end();
});

tape( 'the constructor returns a 64-bit unsigned integer array (no argument, no new)', function test( t ) {
	var ctor;
	var arr;
...
tape( 'the constructor returns a 64-bit unsigned integer array (length)', function test( t ) {
	var arr = new Uint64Array( 10 );
	t.strictEqual( arr instanceof Uint64Array, true, 'returns expected value' );
	t.end();
});

tape( 'the constructor returns a 64-bit unsigned integer array (length, no new)', function test( t ) {
	var ctor;
	var arr;
...
tape( 'the constructor returns a 64-bit unsigned integer array (array)', function test( t ) {
	var arr = new Uint64Array( [] );
	t.strictEqual( arr instanceof Uint64Array, true, 'returns expected value' );
	t.end();
});

tape( 'the constructor returns a 64-bit unsigned integer array (array, no new)', function test( t ) {
	var ctor;
	var arr;
...
tape( 'the constructor returns a 64-bit unsigned integer array (typed array)', function test( t ) {
	var arr = new Uint64Array( new Uint32Array( 0 ) );
	t.strictEqual( arr instanceof Uint64Array, true, 'returns expected value' );
	t.end();
});

tape( 'the constructor returns a 64-bit unsigned integer array (typed array, no new)', function test( t ) {
	var ctor;
	var arr;
...
tape( 'the constructor returns a 64-bit unsigned integer array (unsigned integer typed array)', function test( t ) {
	var arr = new Uint64Array( new Uint64Array( 0 ) );
	t.strictEqual( arr instanceof Uint64Array, true, 'returns expected value' );
	t.end();
});

tape( 'the constructor returns a 64-bit unsigned integer array (unsigned integer typed array, no new)', function test( t ) {
	var ctor;
	var arr;

	ctor = Uint64Array;

	arr = ctor( new Uint64Array( 0 ) );
	t.strictEqual( arr instanceof Uint64Array, true, 'returns expected value' );

	t.end();
});

tape( 'the constructor returns a 64-bit unsigned integer array (iterable)', function test( t ) {
	var Uint64Array;
	var arr;
...
tape( 'the constructor returns a 64-bit unsigned integer array (iterable, no new)', function test( t ) {
	var ctor;
	var arr;
...
tape( 'the constructor returns a 64-bit unsigned integer array (ArrayBuffer)', function test( t ) {
	var arr = new Uint64Array( new ArrayBuffer( 0 ) );
	t.strictEqual( arr instanceof Uint64Array, true, 'returns expected value' );
	t.end();
});

tape( 'the constructor returns a 64-bit unsigned integer array (ArrayBuffer, no new)', function test( t ) {
	var ctor;
	var arr;
...
tape( 'the constructor returns a 64-bit unsigned integer array (ArrayBuffer, byte offset)', function test( t ) {
	var arr = new Uint64Array( new ArrayBuffer( 16 ), 16 );
	t.strictEqual( arr instanceof Uint64Array, true, 'returns expected value' );
	t.end();
});

tape( 'the constructor returns a 64-bit unsigned integer array (ArrayBuffer, byte offset, no new)', function test( t ) {
	var ctor;
	var arr;
...
tape( 'the constructor returns a 64-bit unsigned integer array (ArrayBuffer, byte offset, length)', function test( t ) {
	var arr = new Uint64Array( new ArrayBuffer( 16 ), 16, 0 );
	t.strictEqual( arr instanceof Uint64Array, true, 'returns expected value' );
	t.end();
});

tape( 'the constructor returns a 64-bit unsigned integer array (ArrayBuffer, byte offset, length, no new)', function test( t ) {
	var ctor;
	var arr;
...
tape( 'attached to the constructor is a property returning the number of bytes per array element', function test( t ) {
	t.strictEqual( hasOwnProp( Uint64Array, 'BYTES_PER_ELEMENT' ), true, 'has property' );
	t.strictEqual( Uint64Array.BYTES_PER_ELEMENT, 8, 'returns expected value' );
	t.end();
});

tape( 'attached to the constructor is a property returning the constructor name', function test( t ) {
	t.strictEqual( hasOwnProp( Uint64Array, 'name' ), true, 'has property' );
	t.strictEqual( Uint64Array.name, 'Uint64Array', 'returns expected value' );
	t.end();
});
...
tape( 'the constructor returns an instance having a `BYTES_PER_ELEMENT` property returning the number of bytes per array element', function test( t ) {
	...
	t.strictEqual( hasOwnProp( Uint64Array.prototype, 'BYTES_PER_ELEMENT' ), true, 'has property' );
	t.strictEqual( Uint64Array.prototype.BYTES_PER_ELEMENT, 8, 'returns expected value' );
...
tape( 'the constructor returns an instance having a `byteLength` property for returning the number of bytes belonging to the array view', function test( t ) {
	...
	arr = new Uint64Array( new ArrayBuffer( 128 ), 16 );
	v = arr.byteLength;
	t.strictEqual( v, 112, 'returns expected value' );

	arr = new Uint64Array( new ArrayBuffer( 128 ), 128 );
	v = arr.byteLength;
	t.strictEqual( v, 0, 'returns expected value' );
...
tape( 'the constructor returns an instance having a `byteOffset` property for returning the byte offset pointing to the first array element in the underlying memory', function test( t ) {
	...
	arr = new Uint64Array( new ArrayBuffer( 128 ), 64 );
	v = arr.byteOffset;
...
tape( 'the constructor returns an instance having a `length` property for returning the number of array elements', function test( t ) {
	...
	// Generic array containing `Uint64` instances:
	arr = new Uint64Array( [ new Uint64( 1 ) ] );
	v = arr.length;
	t.strictEqual( v, 1, 'returns expected value' );

	// Typed array:
	arr = new Uint64Array( new Uint32Array( 0 ) );
	v = arr.length;
	t.strictEqual( v, 0, 'returns expected value' );

	arr = new Uint64Array( new Uint32Array( [ 1, 1 ] ) );
	v = arr.length;
	t.strictEqual( v, 2, 'returns expected value' );

	// 64-bit unsigned typed array:
	arr = new Uint64Array( new Uint64Array( 0 ) );
	v = arr.length;
	t.strictEqual( v, 0, 'returns expected value' );

	arr = new Uint64Array( new Uint64Array( [ 1, 1 ] ) );
	v = arr.length;
	t.strictEqual( v, 2, 'returns expected value' );
	...
	arr = new Uint64Array( new ArrayBuffer( 128 ), 64, 2 );
	v = arr.length;
	t.strictEqual( v, 2, 'returns expected value' );
...
tape( 'the constructor returns an instance having a `length` property for returning the number of array elements (iterable)', function test( t ) {
	...
	arr = new Uint64Array( createIterable( iter1 ) );
	t.strictEqual( arr instanceof Uint64Array, true, 'returns expected value' );
	...
	arr = new Uint64Array( createIterable( iter2 ) );
	t.strictEqual( arr instanceof Uint64Array, true, 'returns expected value' );
	...
	if ( HAS_BIGINTS ) {
		...
		arr = new Uint64Array( createIterable( iter3 ) );
		t.strictEqual( arr instanceof Uint64Array, true, 'returns expected value' );
...
tape( 'the constructor throws an error if provided an ArrayBuffer which is not a multiple of 8', function test( t ) {
	...
	function badValue( value ) {
		return function badValue() {
			return new Uint64Array( new ArrayBuffer( value ) );
		};
	}
});
...
tape( 'the constructor throws an error if provided an iterable object which returns values which cannot be converted to a 64-bit unsigned integers', function test( t ) {
	var Uint64Array;
	var values;
	var i;
...
tape( 'the constructor throws an error if provided an array containing values which cannot be converted to a 64-bit unsigned integers', function test( t ) {
	var values;
	var i;
...
tape( 'the constructor throws an error if provided more than one argument and the first argument is not an ArrayBuffer', function test( t ) {
	...
	function badValue( value ) {
		return function badValue() {
			return new Uint64Array( value, 0 );
		};
	}
});
...
tape( 'the constructor throws an error if provided a byte offset argument which is not a nonnegative integer', function test( t ) {
	...
	function badValue( value ) {
		return function badValue() {
			return new Uint64Array( new ArrayBuffer( 64 ), value );
		};
	}
});
...
tape( 'the constructor throws an error if provided a length argument which is not a nonnegative integer (ArrayBuffer)', function test( t ) {
	...
	function badValue( value ) {
		return function badValue() {
			return new Uint64Array( new ArrayBuffer( 128 ), 0, value );
		};
	}
});
...
tape( 'the constructor throws an error if provided a byte offset argument such that the view byte length is not a multiple of 8', function test( t ) {
	...
	function badValue( value ) {
		return function badValue() {
			return new Uint64Array( new ArrayBuffer( 102 ), value );
		};
	}
});
...
tape( 'the constructor throws an error if provided insufficient memory to accommodate byte offset and length arguments', function test( t ) {
	...
	function badValue( value ) {
		return function badValue() {
			return new Uint64Array( new ArrayBuffer( 100 ), value, 1e3 );
		};
	}
});
